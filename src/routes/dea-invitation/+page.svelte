...
<main>
	...
	<p class="message">
		...
		I would be honored if you would join me for a birthday dinner. Let's celebrate this special day with
	...
	<div class="details">
		...
		<div class="detail-item">
			...
			<span
				>Location: <a
					href="https://maps.app.goo.gl/X6D5aqnJG8y7egKw6"
					target="_blank"
					rel="noopener noreferrer"
					style="color: #ffd700; text-decoration: none;">The Westin, Jakarta</a
				></span
			>
		</div>
	</div>
