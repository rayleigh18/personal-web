...
<main>
	<div class="container mx-auto">
		...
		{:else if $questionCounter < questionsLength}
			<div id="questions">
				...
				{#if questions[$questionCounter].imageLink}
					<div>
						<img
							src={questions[$questionCounter].imageLink}
							alt="question"
							class="mt-4"
							width="320px"
						/>
				...
				{#if questions[$questionCounter].additionalInfo}
					<div>
						<a
							href={questions[$questionCounter].additionalInfo.link}
							target="_blank"
							rel="noreferrer"
							class="text-blue-500 mt-4"
							>{questions[$questionCounter].additionalInfo.text}
						</a>
					</div>
				{/if}
				{#if questions[$questionCounter].youtubeId}
					<iframe
						class="youtube-video mt-4"
						src={`https://www.youtube.com/embed/${questions[$questionCounter].youtubeId}`}
						title="YouTube video player"
						allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
						allowfullscreen
					></iframe>
				{/if}
				{#each questions[$questionCounter].answers as answer (answer.text)}
					<button
						on:click={() => {
							if (answer.correct) {
		...
		{:else}
			...
			<img
				src="https://media-cldnry.s-nbcnews.com/image/upload/t_fit-760w,f_auto,q_auto:best/rockcms/2022-11/Laufey-5-te-221108-0188d2.jpg"
				alt="cewe cakep 2"
				class="mt-8"
				width="320px"
			/>
